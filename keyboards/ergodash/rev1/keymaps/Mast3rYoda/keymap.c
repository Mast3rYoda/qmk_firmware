...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   6  |   7  |   8  |   9  |   0  |  Del |                    | Bksp |   #  |   |  |   <  |   >  | Vol+ | Shift|
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_LSFT, DE_6,    DE_7,    DE_8,    DE_9,    DE_0,    KC_DEL ,                        KC_BSPC, KC_BSLS, DE_PIPE, DE_LABK, DE_RABK, KC_AUDIO_VOL_UP, KC_RSFT,
   ...
   * | Esc  |   !  |   @  |   #  |   $  |   %  |   _  |                    |   +  |   ^  |   &  |   *  |   (  |   )  |  |   |
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * | Ctrl |   1  |   2  |   3  |   4  |   5  |  Del |                    | Bksp |   H  |   J  |   K  |   L  |   :  |  "   |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
  ...
  [_RAISE] = LAYOUT(
    ...
    KC_LCTL, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_DEL ,                        KC_BSPC, KC_H,    KC_J,    KC_K,    KC_L,    KC_COLN, KC_DQT ,
